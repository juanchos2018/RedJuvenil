        ...
        <v-row class="spacing8">
          ...
          <v-col cols="12" md="4">
            <div class="title-deco">
              ...
              <title-deco :text="tituloExperieci" />
            </div>
            <u-animate-container>
              <u-animate
                :offset="-100"
...
export default {
  ...
  data() {
    return {
      tituloExperieci:'Nuestas Expriencias',
      subTitule:'El Arte  Transforma',
      parrafo:'Mayor inversión en cultura juvenil es generar mayor inversión para desarrollar la sociedad ',
      loaded: false,
      slickOptions: {
        dots: false,
        infinite: true,
      ...
      expertiseList: [
        ['Fotografias', 'Afiches', 'Pintura'],
        ['Web Development', 'Amigos', 'Mobile Apps'],
        ['Danza', 'Company Profile', 'Visual Editing'],
        ['social media', 'Pintura', 'SEO'],
        ['Web Development', 'UI Designs', 'Mobile Apps'],
        ['Fotografias', 'Afiches', 'Pintura'],
        ['social media', 'Compañerismo', 'SEO'],
        ['Amistad', 'UI Designs', 'Mobile Apps'],
        ['Baile', 'Company Profile', 'Visual Editing']
      ]
    }
  },
  mounted() {
